...
from room_classifier.models import build_mlp
from room_classifier.train_utils import get_device, set_seed, train_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train MLP baseline for room classification.")
...
def main() -> None:
    ...
    model = build_mlp(len(info.class_names), img_size=args.img_size, dropout=args.dropout)
